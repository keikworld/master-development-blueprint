...
\`\`\`
I want to build a $PROJECT_TYPE project called '$PROJECT_NAME'.
I'm using $LANG with $PKG_MGR.

Read MASTER_DEVELOPMENT_BLUEPRINT/00-USE-WITH-ANY-LLM.md first,
then read my project files, then start the discovery phase.

$([ "$PROJECT_TYPE" = "web-api" ] && echo "I want to deploy this quickly. Show me the weekend workflow if my project fits it.")
\`\`\`
README
echo "  [done] README.md"
...
if [ "$PROJECT_TYPE" = "web-api" ]; then
  cp "$SCRIPT_DIR/MASTER_DEVELOPMENT_BLUEPRINT/scripts/deploy/Dockerfile" "$TARGET_DIR/Dockerfile"
  echo "  [done] Dockerfile"
  cp "$SCRIPT_DIR/MASTER_DEVELOPMENT_BLUEPRINT/scripts/deploy/railway.json" "$TARGET_DIR/railway.json"
  echo "  [done] railway.json"
fi
...
echo "   $TARGET_DIR"
echo ""
echo " COPY-PASTE THIS TO YOUR LLM (Claude, GPT, Gemini, etc.):"
echo ""
echo "========================================================================"
echo " I want to build a $PROJECT_TYPE project called '$PROJECT_NAME'."
echo " I'm using $LANG with $PKG_MGR."
echo ""
echo " Read MASTER_DEVELOPMENT_BLUEPRINT/00-USE-WITH-ANY-LLM.md first,"
echo " then read my project files (in the repo I just created),"
echo " then start the discovery phase."
echo ""
if [ "$PROJECT_TYPE" = "web-api" ]; then
echo " I want to deploy this quickly. Show me the weekend workflow"
echo " if my project fits it."
fi
echo "========================================================================"
echo ""
echo " Next steps:"
echo "   1. cd $PROJECT_NAME"
echo "   2. git remote add origin <your-repo-url> && git push"
echo "   3. Copy-paste the prompt above to your LLM"
echo "   4. Answer questions as the LLM walks you through"
echo "   5. Have a working project by end of weekend"
echo ""
echo " For deploy templates, see the blueprint's"
echo " MASTER_DEVELOPMENT_BLUEPRINT/scripts/deploy/ directory."
echo "========================================================================="
